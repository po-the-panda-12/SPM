        ...
        <div class="card-body">
            ...
            <div v-if="countActiveSkills(role.skills) > 0">
                ...
                <div v-if="countActiveSkills(role.skills) > 4" class="mt-2">
                    <span data-test="modal" class="btn btn-outline-dark badge rounded-pill text-bg-dark mb-3" data-bs-toggle="modal" :data-bs-target="'#staticBackdrop'+role.role_id">See more</span><br>
