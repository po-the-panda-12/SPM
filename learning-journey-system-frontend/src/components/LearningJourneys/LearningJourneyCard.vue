    ...
    <div class="row">
        <div class="col">
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-2 mx-auto col-sm-2 col-md-2 col-lg-2" style="display:flex; align-items:center;">
                            <img src="https://blush.design/api/download?shareUri=WpJInu49H&w=800&h=800&fm=png" alt="" style="width:100%">
                        </div>
                        <div class="col-8 m-auto col-sm-10 col-md-6">
                        ...
                        <div class="col-4 col-sm-4 m-auto">
